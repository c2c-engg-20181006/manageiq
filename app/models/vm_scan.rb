class VmScan < Job
  ...
  def call_snapshot_create
    ...
    begin
      ...
      if vm.kind_of?(ManageIQ::Providers::Openstack::CloudManager::Vm) || vm.kind_of?(ManageIQ::Providers::Otc::CloudManager::Vm) || vm.kind_of?(ManageIQ::Providers::Telefonica::CloudManager::Vm) || vm.kind_of?(ManageIQ::Providers::Huawei::CloudManager::Vm) || vm.kind_of?(ManageIQ::Providers::Orange::CloudManager::Vm) || vm.kind_of?(ManageIQ::Providers::Microsoft::InfraManager::Vm)
    ...
    if context[:snapshot_mor]
      ...
      if vm.ext_management_system
        ...
        begin
          # TODO: should this logic be moved to a VM subclass implementation?
          #       or, make type-specific Job classes.
          if vm.kind_of?(ManageIQ::Providers::Openstack::CloudManager::Vm) || vm.kind_of?(ManageIQ::Providers::Otc::CloudManager::Vm) || vm.kind_of?(ManageIQ::Providers::Telefonica::CloudManager::Vm) || vm.kind_of?(ManageIQ::Providers::Huawei::CloudManager::Vm) || vm.kind_of?(ManageIQ::Providers::Orange::CloudManager::Vm)
        ...
        if vm.ext_management_system
          if options[:snapshot] == :smartProxy
            ...
            if vm.kind_of?(ManageIQ::Providers::Openstack::CloudManager::Vm) ||
               ...
               vm.kind_of?(ManageIQ::Providers::Otc::CloudManager::Vm) ||
               vm.kind_of?(ManageIQ::Providers::Huawei::CloudManager::Vm) ||
