  ...
  def save_firewall_rules_inventory(parent, hashes, mode = :refresh)
    ...
    find_key =
      ...
      when :refresh
        ...
        if parent.kind_of?(ManageIQ::Providers::Openstack::NetworkManager::SecurityGroup) || parent.kind_of?(ManageIQ::Providers::Otc::NetworkManager::SecurityGroup) || parent.kind_of?(ManageIQ::Providers::Telefonica::NetworkManager::SecurityGroup) || parent.kind_of?(ManageIQ::Providers::Huawei::NetworkManager::SecurityGroup) || parent.kind_of?(ManageIQ::Providers::Orange::NetworkManager::SecurityGroup)
          [:ems_ref]
        else
